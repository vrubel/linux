...
static u32 bh1730_itime_ns(struct bh1730_data *bh1730)
{
...
{
	int ret;
	u32 time_ns = time_ms * (u32)NSEC_PER_MSEC;
	u32 itime_step_ns = BH1730_INTERNAL_CLOCK_NS * 964;
...
static s32 bh1730_get_millilux(struct bh1730_data *bh1730)
{
	int visible, ir, visible_coef, ir_coef;
	u32 itime_us = bh1730_itime_ns(bh1730) / NSEC_PER_USEC;
	u32 millilux;
	...
	millilux = (u32)USEC_PER_MSEC * (visible_coef * visible - ir_coef * ir);
